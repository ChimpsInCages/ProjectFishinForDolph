...
public class DialogueSequencer
{
    ...
    public void StartDialogue(Dialogue dialogue)
    {
        ...
        {
            throw new DialogueException("Can start a new dialogue when another is already running");
        }
    }
    public void EndDialogue(Dialogue dialogue)
    {
        ...
        {
            throw new DialogueException("Trying to styop a dialogue that isn't running");
        }
    }
